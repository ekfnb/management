<template>
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ path: '/success_list'}">成功项目管理</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/success_list'}">审核通过项目列表</el-breadcrumb-item>
...
export default {
    ...
    methods:{
        ...
        getUpdateData(){
            ...
            ajax({url:'/my/projectSuccess/getProjectSuccess_id',
            data:{id},
        ...
        sendAjax(id,name,alias,articleContent,user_pic,region){
            ajax({url:'/my/projectSuccess/updateProjectSuccess',
            data:{
                id,
                name,
                alias,
