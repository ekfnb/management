<template>
    <div >
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>审核通过项目列表</el-breadcrumb-item>
        </el-breadcrumb>
        <el-card>
...
export default {
    ...
    methods:{
        ...
        getReleaseList(){
            ...
            // this.Url = Url
            ajax({url:"/my/projectSuccess/getProjectSuccessPage",
            data:layoutData,
        ...
        search(){
            if(this.name !== ''){
                this.tableData = []
                ajax({url:"/my/query/success_query",
                data:{name:this.name},
                header:{"Content-Type": "application/x-www-form-urlencoded"},
                method:"post" 
                }).then(res=>{
        ...
        handleDelete(index,row){
            ...
            ajax({url:"/my/projectSuccess/delectProjectSuccess",
            data:{id},
            header:{"Content-Type": "application/x-www-form-urlencoded"},
            method:"post"
            }).then(res=>{
