<template>
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ path: '/fail_list' }">失败项目管理</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/fail_list' }">审核失败项目列表</el-breadcrumb-item>
            <el-breadcrumb-item>修改项目信息</el-breadcrumb-item>
        </el-breadcrumb>
        <el-card>
            <el-form :label-position="labelPosition" style="margin:0 auto" label-width="80px" :model="formLabelAlign">
                ...
                <el-button type="primary" @click="handlerRelease">修改项目</el-button>
            </el-form>
        </el-card>
    </div>
</template>
...
export default {
    ...
    methods:{
        ...
        getUpdateData(){
            ...
            ajax({url:'/my/projectFailed/getProjectFailedId',
            data:{id},
        ...
        handlerRelease(){
            ...
            if (this.getResponse.length !== 0) {
                ...
                this.sendAjax(id,name,alias,articleContent,user_pic,region)
            }else{
        ...
        //修改上传项目方法
        sendAjax(id,name,alias,articleContent,user_pic,region){
            ajax({url:'/my/projectFailed/updateProjectFailed',
            data:{
                id,
                name,
                alias,
