<template>
    <div >
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>审核项目列表</el-breadcrumb-item>
        </el-breadcrumb>
        <el-card>
        ...
        style="width: 95%">
            ...
            <el-table-column label="操作" width="190">
                <template slot-scope="scope">
                    <el-button
                    size="mini"
                    @click="handleEdit(scope.$index, tableData)" type="primary" icon="el-icon-edit">上传/修改</el-button>
                    <el-button
                    size="mini"
                    type="danger"
...
export default {
    ...
    methods:{
        ...
        getReleaseList(){
            ...
            // this.Url = Url
            ajax({url:"/my/projectVote/getProjectVotePage",
            data:layoutData,
        ...
        search(){
            if (this.name !== '') {
                this.tableData = []
                ajax({url:"/my/query/examine_query",
                data:{name:this.name},
                header:{"Content-Type": "application/x-www-form-urlencoded"},
                method:"post" 
                }).then(res=>{
        ...
        handleDelete(index,row){
            ...
            ajax({url:"/my/projectVote/delectProjectVote",
            data:{id},
            header:{"Content-Type": "application/x-www-form-urlencoded"},
            method:"post"
            }).then(res=>{
